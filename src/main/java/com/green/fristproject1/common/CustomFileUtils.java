...
public class CustomFileUtils {
    ...
    public CustomFileUtils(@Value("${file.directory}") String path){
        this.path=path;
    }

    public String makeRandomFileName(){return String.format("%s", UUID.randomUUID());}
    public String makeRandomFileName(String fileName){return String.format("%s%s", makeRandomFileName(), getTmp(fileName));}
